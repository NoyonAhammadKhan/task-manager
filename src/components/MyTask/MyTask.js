			...
			<tbody>
				{
					...
					<td className="p-3">
					<Link to={`/taskdetails/${task._id}`}> <button type="button" className="text-gray-900 bg-gradient-to-r from-cyan-200 via-cyan-400 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Details</button></Link> 
					</td>
					<td className="p-3">
